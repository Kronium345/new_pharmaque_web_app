            ...
            <main>
                ...
                <div class = "row g-0">
                    ...
                    <Link to="/upcomingevents" class = "removeunderline activelink">
                        <p class = "py-3 m-0">
                        <img src = "images/UpcomingEventsColour.png" class="navigationicon" alt="icon"/>
                    ...
                    <div class = "row">
                        ...
                        <div class = "card p-4">                
                            <form class = "d-flex mb-3" role = "search">
                                ...
                                <span class="input-group-text"><img src = "images/SearchIcon.png" class = "smallericon mx-1" alt="icon"/></span>
                                <input class="form-control px-2 py-2" type="search" placeholder="Search Exam Topic Name" aria-label="Search"/>
                                </div>
                            </form>
                            <div class = "row py-2 m-0 px-0 lightgrey center mb-3">
                                <button class = "addeventbutton"><img src = "images/AddIcon.png" class = "mediumicon" alt="icon"/></button>
                            </div>
                            ...
                            <div class = "row">
                                ...
                                <div class = "card p-4 mediumbluebg">
                                    ...
                                    <div class = "col-sm-9">
                                        ...
                                        <p class = "fs-5 whitetext fw-bold">Saturday, 28th October 2023, 10:00 AM</p>
                                    </div>
