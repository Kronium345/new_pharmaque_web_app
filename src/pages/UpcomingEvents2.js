            ...
            <main>
                ...
                <div class = "row g-0">
                    ...
                    <a href = "#" class = "removeunderline activelink">
                        <p class = "py-3 m-0">
                        <img src = "images/UpcomingEventsColour.png" class="navigationicon"/>
                    ...
                    <div class = "row">
                        ...
                        <div class = "card p-4 navybluebg">                
                            <p class = "center mb-4"><a href = "#" class = "removeunderline floatleft"><img src = "images/backarrowicon.png" class = "tinyicon"/><span class = "whitetext fs-5  mx-3">Back</span></a>
                            <span class = "whitetext fs-4 fw-bold center">Add Exams</span>
                            </p>
                            
                            <input type="text" class="form-control px-4 py-2 fs-5 mb-3" id="examTitleInput" placeholder="Enter Exam Title"/>
                            
                            <select class="form-select px-4 py-2 fs-5 mb-3" aria-label="Default select example">
                            ...
                            <option value="7">Obstetrics, Gynaecology and Genitourinary tract</option>
                            <option value="8">Malignant Disease and Immunosuppression</option>
                            ...
                            <option value="13">Immunological products and vaccines</option>
                            <option value="14">Musculoskeletal & Joint diseases</option>
                            ...
                            <p class = "fs-5 whitetext fw-bold pb-0 pt-2">Select Exam Date</p>
                            <input type = "date" class = "form-control px-4 py-2 fs-5 mb-4"/>

                            <div class = "center">
                            <button type="submit" class="btn-tertiary fs-5 px-4 py-2 fw-bold">Save</button>
                            </div>
