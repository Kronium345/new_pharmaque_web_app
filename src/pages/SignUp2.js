        ...
        return(
            <main>
                ...
                <div class = "row p-5">
                    ...
                    <img src = "images/UniversityImage.png" class = "img-fluid exampleimage"/>
                    </div>
                    ...
                    <h1 class = "h3 fw-bold leftalign">Which university did you attend?</h1>
                    <p class = "fs-5 leftalign">Tell us about your university. Unlock tailored content and resources!</p>
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                        <input type="text" class="form-control py-2" placeholder="If other, please specify"/>
                        </div>
