                ...
                <div class = "container-fluid p-0">
                    <div class = "row g-0">
                        ...
                        <Link to="/pastchapters" class = "removeunderline activelink">
                            <p class = "py-3 m-0">
                            <img src = "images/PastChaptersColour.png" class="navigationicon" alt="navigation"/>
                            ...
                            <div class = "card p-4">                
                                ...
                                <div class = "row">
                                    ...
                                    <div class = "card p-4 mediumbluebg">
                                        <div class = "row">
                                        <div class = "col-sm-3">
                                            <img src = "images/GastroIcon.png" class = "icon" alt="gastro"/>
                                        </div>
                                        <div class = "col-sm-9">
                                            <p class = "fs-5 fw-bold whitetext mb-1">
                                            Gastrointestinal System
                                            </p>
                                            <p class = "fs-6 whitetext mb-3">100/100 Questions Attempted</p>

                                            <p><img src = "images/ScoreIcon.png" class = "moderateicon" alt="score"/><span class = "whitetext fw-bold mx-3">80 / 100 Scored</span></p>

                                            <Link to="" class = "removeunderline boldtext navybluetext fw-bold"><div class = "px-3 py-2 whitebg pseudobutton">Retake Chapter</div></Link>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
