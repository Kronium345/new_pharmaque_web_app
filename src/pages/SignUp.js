...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:7171/auth/signup', {
            username, 
            email, 
            password
        }).then(response => {
                ...
                <div className="container-fluid">
                    <div className="row p-5">
                        ...
                        <div className="col-sm-6 p-5 rightside">
                            ...
                            <p className="fs-5 leftalign">Welcome to PharmaQue! Follow the steps below to create your account on this website.</p>
                            <form onSubmit={handleSubmit}>
                            <div className="mb-3">
                                    <input type="username" className="form-control py-2" id="exampleUsername1" placeholder="Enter Username" onChange={(e) => setUsername(e.target.value)} />
                                </div>
                                <div className="mb-3">
                                ...
                                <p className="fs-5 leftalign mt-2">Already have an account? <Link to="/" className="fw-bold link">Login</Link></p>
                            </form>
                        </div>
                    </div>
                </div>
