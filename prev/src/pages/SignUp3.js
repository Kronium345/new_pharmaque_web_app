          ...
          <div class="container-fluid">
            <div class="row p-5">
              <div class="col-sm-6 p-5 leftside">
                <img
                  src="images/Pharmacists.png"
                  class="img-fluid exampleimage"
                />
              </div>
              <div class="col-sm-6 p-5 rightside">
                <div class="progress mb-3" role="progressbar">
                  <div class="progress-bar fw-bold" style={{ width: "40%" }}>
                    40%
                  </div>
                </div>
                ...
                <p class="fs-5 leftalign">
                  Select which category of pre-registration pharmacists you
                  belong to.
                </p>
                ...
                <form>
                  <div class="form-check py-2 px-3 mb-3">
                    ...
                    <input
                      class="form-check-input fs-5 mx-0"
                      type="radio"
                      name="optionone"
                      id="optionone"
                      value="option1"
