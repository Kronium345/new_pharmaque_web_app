...
const MyAccount = () => {
    ...
    const handleLogout = () => {
        axios.get('http://localhost:7171/auth/logout')
        .then(res => {
            if(res.data.status) {
                navigate('/')
            }
                    ...
                    <div className="col-sm-3 leftnavigation p-4">
                        ...
                        <Link to="/dashboard" className="removeunderline inactivelink">
                            <p className="pt-5 pb-3 m-0">
                                <img src="images/DashboardGrey.png" className="navigationicon" alt="navigation" />
                        ...
                        <Link to="/chapters" className="removeunderline inactivelink">
                            <p className="py-3 m-0">
                                <img src="images/ChaptersGrey.png" className="navigationicon" alt="navigation" />
                            ...
                            <div className="col-sm-12">
                                <div className="card p-4">
                                    <div className="col-sm-12 center">
                                        <img src="images/10.png" className="logo mb-2" alt="10"/>
                                        <input type="file" accept="image/*" onChange={handleFileChange} />
                                        <button className="btn btn-tertiary fs-5 fw-bold mb-2" onClick={handleAvatarChange}>Change Avatar</button>
                                        <p className="fs-4 fw-bold mb-1">Username123</p>
                                        <p className="fs-5 mediumnavytext mb-3">adityag774@gmail.com</p>
                                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            <button className="btn btn-tertiary fs-5 fw-bold mb-2" onClick={handleLogout}>Logout</button>
                                        </div>
                                    </div>
